  ...
  return(
    ...
    <div className="container">
        ...
        <ol>
            ...
            <li id="footnote-4">High attendance = 90% and above attendance rate.</li>
            <li id="footnote-5">Low attendance = below 90% attendance rate, this is considered chronically absence.</li>
        </ol>
    </div>
</div>
  )
