            ...
            const {blockData1, blockData2} = this.state;
              ...
              return (
                <div className="container">
                  ...
                  <div className="row">
                    <Description>
                      <p>Action Steps: Attendance and Behavior matters in all grades!</p>
                    </Description>
                  </div>
                </div>
