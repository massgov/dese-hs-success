      ...
      <div className="container target-nav" id="intro" name="intro">
        <div className="row">
          <div className="col-md-12">
            ...
            <p>While the ABCs are important throughout high school, the information below provides a snapshot of how specific ABCs can significantly impact a student’s future at each stage of their high school journey. It might not be surprising that students who pass every class in 9th grade are more likely to graduate on time than their classmates. However, it might be surprising that they’re odds of graduating on time is 14 times higher.<FootNoteLink index={1}/>
            </p>
