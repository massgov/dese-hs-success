...
import BlockCount1 from './BlockCount1'
import { ChartSubTitle } from './ChartTitle'
import Description from '../Description'
import BlockCountLegend1 from './BlockCountLegend1'
      ...
      render = () =>  {
          ...
          return(
                <div>
                  ...
                  <div className="row">
                    <div className="col-md-12">
                          <BlockCount1 array = {array} />
                          <hr />
                          <BlockCountLegend1 legendArray={uniqueArray} selected={selected}/>
                    </div>
                  </div>
                </div>
