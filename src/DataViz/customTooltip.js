      ...
      if (number === 'one') {
        return (
          <div className="custom-tooltip">
            ...
            <hr />
            <p style={{color: `${color_all}`}}>Among <b>{total_all}</b> students who failed {number} course, <b>{all}%</b> graduated in 4 years.</p>
            <p style={{color: `${color_core}`}}>Among <b>{total_core}</b> students who failed {number} core course, <b>{core}%</b> graduated in 4 years.</p>
          </div>
        )
      }      
      return (
